...
Today, Rapier provides only a language for API specifications and a tool for generating Swagger docments from them. In the future we intentd to work on test tools,
