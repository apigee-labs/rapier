...
This section contains some opinion about API design and is not specific to Rapier—it is really an apology for the the design of the [To-do List example](#to_do_list) above. If you are not interested in this opinion, you can [skip to the next section](#representing-urls).
