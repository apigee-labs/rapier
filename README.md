...
URL \{`child-URL`\}/mother is guaranteed to be a valid URL, and further, it is guaranteed to be an alias for the URL in the 'mother' property of the resource at `child-URL`. 
